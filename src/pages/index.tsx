  ...
  return (
    <button onClick={onClick} className="px-3">
      {sortKey === columnKey ? (
        ...
        <SortDescendingIcon className="-mb-2 col-start-1 row-start-1 h-5 w-5 text-slate-300 duration-300 ease-out" />
      )}
    </button>
  );
}
...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto flex min-h-screen flex-col justify-center gap-4 p-4">
        ...
        <table className="w-full divide-y divide-gray-300 rounded-md shadow-sm">
